...
class UserDetails extends Model
{
    ...
    public function employmentType() {
        return $this->belongsTo(ReferenceData::class, 'employment_type')->where('type', 'employmentTypes');
    }
    
    public function industry() {
        return $this->belongsTo(ReferenceData::class, 'industry')->where('type', 'industries');
    }
    ...
    public function bodyType() {
        return $this->belongsTo(ReferenceData::class, 'body_type')->where('type', 'bodyTypes');
    }
    
    public function complexion() {
        return $this->belongsTo(ReferenceData::class, 'color')->where('type', 'complexions');
    }
    ...
    public function religion() {
        return $this->belongsTo(ReferenceData::class, 'religion')->where('type', 'religions');
    }
    
    public function physicalStatus() {
        return $this->belongsTo(ReferenceData::class, 'physical_status')->where('type', 'physicalStatus');
    }
    
    public function familyStatus() {
        return $this->belongsTo(ReferenceData::class, 'family_status')->where('type', 'familyStatus');
    }
    ...
    public function travelPreference() {
        return $this->belongsTo(ReferenceData::class, 'travel_preference')->where('type', 'travelPreferences');
    }
    ...
    public function getLanguagesKnownValuesAttribute()
    {
        ...
        return ReferenceData::where('type', 'languagesKnown')->where('id', $ids)->get();
    }
    ...
    public function getFavoriteCuisineListAttribute() {
        $ids = explode(',', $this->favorite_cuisine);
        return ReferenceData::whereIn('id', $ids)->where('type', 'cuisines')->get();
    }

    public function getMusicGenreListAttribute() {
        $ids = explode(',', $this->favorite_music);
        return ReferenceData::whereIn('id', $ids)->where('type', 'musicGenres')->get();
    }

    public function getSportsFitnessListAttribute() {
        $ids = explode(',', $this->sports);
        return ReferenceData::whereIn('id', $ids)->where('type', 'sportsFitness')->get();
    }    
}
